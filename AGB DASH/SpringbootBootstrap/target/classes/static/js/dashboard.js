    ...
    datasets: [
      {
        ...
        pointHoverBackgroundColor: "rgb(218,7,7)",
      },
    ],
  },
  options: {
    ...
    datasets: [
      {
        ...
        pointRadius: 3,
        pointBackgroundColor: "transparent",
        pointHoverBackgroundColor: "rgb(229,6,6)",
      },
    ],
  },
  options: {
...
var myBar = new Chart(ctxBar, {
  ...
  data: {
    ...
    datasets: [{
      label: 'Students',
      backgroundColor: [chartColors.info, chartColors.info, chartColors.info, chartColors.info, chartColors.info, chartColors.blue, chartColors.info],
      data: [
        5, 
        10, 
        30, 
